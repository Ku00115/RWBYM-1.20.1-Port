...
import io.github.blaezdev.rwbym.client.model.legacy.MathHelper;
...
public class ModelBeringle extends ModelBase {
	...
	public ModelBeringle() {
		...
		Torso.cubeList.add(new ModelBox(Torso, 0, 299, 7.0F, -11.4811F, 12.1733F, 3, 3, 1, 0.0F, false));
		...
		Torso.cubeList.add(new ModelBox(Torso, 0, 299, 7.0F, 10.714F, 4.7015F, 4, 2, 5, 0.0F, false));
		Torso.cubeList.add(new ModelBox(Torso, 16, 299, 24.0F, -15.273F, 5.0075F, 3, 0, 2, 0.0F, false));
		Torso.cubeList.add(new ModelBox(Torso, 6, 318, -8.0F, -12.7019F, -12.9284F, 14, 10, 4, 0.0F, false));
		Torso.cubeList.add(new ModelBox(Torso, 6, 318, -9.0F, -16.9784F, -11.438F, 10, 9, 1, 0.0F, false));
		Torso.cubeList.add(new ModelBox(Torso, 6, 318, 12.0F, -13.8409F, -13.5579F, 10, 8, 4, 0.0F, false));
		Torso.cubeList.add(new ModelBox(Torso, 6, 318, 9.0F, -11.9358F, -13.5712F, 14, 10, 4, 0.0F, false));
		...
		Torso.cubeList.add(new ModelBox(Torso, 6, 318, 24.0F, 13.9967F, -0.5319F, 2, 1, 9, 0.0F, false));
		...
		Head.cubeList.add(new ModelBox(Head, 67, 305, 14.4063F, 3.7242F, -7.3526F, 1, 1, 1, 0.0F, false));
	...
	public void setLivingAnimations(LivingEntity par1LivingEntity, float par2, float par3, float par4) {
