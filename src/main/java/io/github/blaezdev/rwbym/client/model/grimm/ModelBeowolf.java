...
public class ModelBeowolf extends ModelBase {
    ...
    public void render(Entity parEntity, float parTime, float parSwingSuppress, float par4, float parHeadAngleY, float parHeadAngleX, float par7) {
        renderBeowolf((io.github.blaezdev.rwbym.entity.BasicGrimmEntity) parEntity, parTime, parSwingSuppress, par4, parHeadAngleY, parHeadAngleX, par7);

    }

    public void renderBeowolf(io.github.blaezdev.rwbym.entity.BasicGrimmEntity parEntity, float parTime, float parSwingSuppress, float par4, float parHeadAngleY, float parHeadAngleX, float par7) {
